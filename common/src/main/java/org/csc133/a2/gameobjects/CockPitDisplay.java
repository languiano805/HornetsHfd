...
public class CockPitDisplay extends Fixed{
    ...
    public CockPitDisplay(Dimension worldSize, Helicopter helicopter,
                          Fires fires, Buildings buildings){
        ...
        this.location = new Point2D(worldSize.getWidth()*0.05,
                worldSize.getHeight()*0.05);
